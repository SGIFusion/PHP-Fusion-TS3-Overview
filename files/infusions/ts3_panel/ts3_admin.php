...
if(isset($_POST['save_data'])) {
	...
	$tssitelist = stripinput($_POST['tssitelist']);
	...
	while($data = dbarray($res_db)) {
		...
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over025']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'><input type='text' class='textbox' name='host' style='width:200px;' value='".$data['host']."' placeholder='127.0.0.1'></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over026']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over027']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'><input type='text' class='textbox' name='query_port' style='width:200px;' value='".$data['query_port']."' placeholder='10011'></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over028']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over029']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'><input type='text' class='textbox' name='port' style='width:200px;' value='".$data['port']."' placeholder='9987'></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over030']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over060']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over061']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over062']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over063']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over035']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'><input type='text' class='textbox' name='admin_login' style='width:200px;' value='".$data['admin_login']."' placeholder='serveradmin'></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over036']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over037']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'><input type='text' class='textbox' name='admin_passw' style='width:200px;' value='".$data['admin_passw']."' placeholder='your server password'></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over038']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over064']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				echo "<select name='tssitelist' style='width:200px;' class='textbox'>";
					echo "<option value=''(".($data['tssitelist'] == '' ? " selected" : "").">".$locale['ts3over102']."</option>";
					echo "<option value='0'(".($data['tssitelist'] == '0' ? " selected" : "").">".$locale['ts3over042']."</option>\n";
					echo "<option value='1'(".($data['tssitelist'] == '1' ? " selected" : "").">".$locale['ts3over043']."</option>\n";
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over065']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over066']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over067']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over068']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over069']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over070']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over071']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over072']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over073']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over074']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over075']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over114']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over115']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over076']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over077']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over078']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over079']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over080']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over081']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over082']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over083']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over084']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over085']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over086']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over087']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over120']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over121']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over088']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over089']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over090']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over091']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over110']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over111']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over117']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over118']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over092']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over093']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over094']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over095']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over107']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over108']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over096']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'><input type='text' class='textbox' name='pass_site' style='width:200px;' value='".$data['pass_site']."' placeholder='your server join password'></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over097']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over098']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over099']."</em></td>";
		echo "</tr>\n";
		
		echo "<tr>\n";
			echo "<td align='left' width='220px' class='tbl'><strong>".$locale['ts3over100']."</strong></td>";
			echo "<td align='left' width='330px' class='tbl'>";
				...
				echo "</select></td>";
			echo "<td align='left' class='tbl'><em>".$locale['ts3over101']."</em></td>";
		echo "</tr>\n";
